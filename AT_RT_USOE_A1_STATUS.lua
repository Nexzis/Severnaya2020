-- скрипт установления достоверности сигнала в зависимости от состояния модуля и канала ПЛК А1 УСО Э вер. от 12-09-18
--Блок глобальных изменяемых для каждого узла переменных
 g_Logs=true 
 g_ScreenID="ZRU" 
 g_USO_ID="USOE_" -- идентификатор технологического объекта
 g_PLC_Name="A1_" -- название контроллера в УСО
 g_ObjDesc= "ЗРУ-10кВ. "--описание источника сигналов
 g_PLC_Desc="УСО Э. ПЛК A1" 
