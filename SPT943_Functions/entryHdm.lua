...
function entryHdm( archiveType, firstUnixDT, lastUnixDT)
	...
	if lastUnixDT < firstDT or lastDT < lastUnixDT then
		Core.WarningMessageVisible = true;
		Core.WarningMessage = 'Конец периода ' .. os.date("%d.%m.%Y %H:%M", firstUnixDT) .. '\nнаходится за пределами архива!\n\n' .. 'Начало архива: ' .. os.date("%d.%m.%Y %H:%M", firstDT) .. '\nКонец архива: ' .. os.date("%d.%m.%Y %H:%M", lastDT);
		-- ВИДИМО УДАЛИТЬ!!! Core.WarningMessage = "Выбранный год - " .. year .. "\nнаходится за пределами архива,\n\n" .. "начало архива: " .. strYearStart .. ",\n конец архива: " .. strYearEnd .. ".";
		print( 'Начало архива: ' .. os.date("%d.%m.%Y %H:%M", firstDT));
		print( 'Конец архива: ' .. os.date("%d.%m.%Y %H:%M", lastDT));
		cur:close();
...
--local firstUnixDT = 1510628399; -- h
--local archiveType = "HourArchive_1";
--local archiveType = "DateArchive_1";
--local firstDT = 1475614800; -- d
--local archiveType = "MonthArchive_1";
--local firstDT = 1451509200; -- m

--entryHdm( firstUnixDT, archiveType);
