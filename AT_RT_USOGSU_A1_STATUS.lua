-- скрипт установления достоверности сигнала в зависимости от состояния модуля и канала ПЛК А1 УСО ГЩук вер. от 12-09-18
--Блок глобальных изменяемых для каждого узла переменных
 g_Logs=true 
 g_ScreenID="GSU" 
 g_USO_ID="USOGSU_" -- идентификатор технологического объекта
 g_PLC_Name="A1_" -- название контроллера в УСО
 g_ObjDesc= "МСС-7. "--описание источника сигналов
 g_PLC_Desc="УСО ГЩУ. ПЛК A1" 
