...
local ObjID = "Hobbit1_params."
local sig_source="Хоббит 1" 
local time_source = "" 
DRFlag = Core["HOBBIT1_DS_DP"]
old_DRFlag = DRFlag 
...
function Check_Data_Reliability ()
  ...
  local DRFlag = Core["HOBBIT1_DS_DP"]                            --статус выполнения обращений к устройству если не равен 0, то устройство не исправно
...
Core.onExtChange({"HOBBIT1_DS_DP"}, Check_Data_Reliability)
