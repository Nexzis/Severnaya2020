...
local group_prefix = {"SPAC_VV1_803.",
                      "SPAC_SV_803.",
                      "SPAC_1_1_803.",
                      "SPAC_1_2_803.", 
                      "SPAC_1_3_803.",
...
local function rewrite_read_settings(rewrite_group)
  ...
  if Core[rewrite_group[1]..raw_prefix..rewrite_signals_on_write] == true then
    ...
    local delay_for_read = 0
    while Core[rewrite_group[1]..raw_prefix..signal_on_read_L2210] == true or delay_for_read < 30 do
      os.sleep(0.1)
      delay_for_read = delay_for_read + 1
    end
    ...
    delay_for_read = 0
    while Core[rewrite_group[1]..raw_prefix..signal_on_read_4D28] == true or delay_for_read < 30 do
      os.sleep(0.1)
      delay_for_read = delay_for_read + 1
    end
