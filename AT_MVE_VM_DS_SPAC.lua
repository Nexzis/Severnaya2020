...
local spac_source = {["VV1_803."] = "ЗРУ 10кВ Ввод1",
                     ["1_1_803."] = "ЗРУ 10кВ T5 КТП ВОС",
                     ["1_3_803."] = "ЗРУ 10кВ Ячейка 1_3",
                     ["1_2_803."] = "ЗРУ 10кВ Ячейка 1_2",
                     ["1_4_803."] = "ЗРУ 10кВ Ячейка 1_4",                   
                     ["1_6_803."] = "ЗРУ 10кВ T3 КТП вспомогательной зоны",
                     ["1_7_803."] = "ЗРУ 10кВ Ячейка 1_7", 
                     ["1_8_803."] = "ЗРУ 10кВ Ячейка 1_8",
                     ...
                     ["2_9_803."] = "ЗРУ 10кВ Ячейка 2_9",
                     ["2_10_803."] = "ЗРУ 10кВ Ячейка 2_10",
                     ["2_11_803."] = "ЗРУ 10кВ Т4 Вспомогательной зоны",
                     ["2_13_803."] = "ЗРУ 10кВ Ячейка 2_13",
                     ["2_14_803."] = "ЗРУ 10кВ Ячейка 2_14",
                     ["2_15_803."] = "ЗРУ 10кВ Ячейка 2_15",
                     ["2_16_803."] = "ЗРУ 10кВ Ячейка 2_16",
                     ["2_17_803."] = "ЗРУ 10кВ Т6 ВОС",
                     ["2_18_803."] = "ЗРУ 10кВ Ячейка 2_18",}

local spac_prefix = "SPAC_"

local spacs_list = {"VV1_803.",
                    "SV_803.",
                    "1_1_803.",
                    "1_2_803.", 
                    "1_3_803.",
...
local function Add_DS_Event(signal)
  ...
  if Core[signal[1]..signal[2]..signal[3]] == 2 then -- заплатка на модбас --or Core[signal]==true then
    Core.addEvent("Потеря связи с устройством", AS, 1, spac_source[signal[2]], user, signal[1]..signal[2]..signal[3], DT_POSIX, screen_id)
  ...
  elseif Core[signal[1]..signal[2]..signal[3]] <= 1 then -- заплатка на модбасor Core[signal]==false then
    Core.addEvent("Потеря связи с устройством", AS, 0, spac_source[signal[2]], user, signal[1]..signal[2]..signal[3], DT_POSIX, screen_id)
