...
local DO_Signals=  -- таблица соответствия дискретных выходов тэгам - привязка тэгов и их свойств к конкретному каналу ПЛК в формате "ПЛК_Слот.Канал
 ...
 ["A1_5.o1"]={Tag="DO_ART2_H_ON", Comment="ВОС. Пуск/стоп насоса артскважины №2", Txt_1 ="Пуск", Txt_0 ="Стоп", InvFlag=false, AlarmClass=100, AlarmMsg="_", reliabilityFlag=true,repaireFlag=false, Fix_Con=true, Source="ВОС. Насос артскважины №2 ",},
